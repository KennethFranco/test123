 ...
 */
export declare class AsyncAirtable {
    /**
     * @default=true
...
export declare const CREATED_TIME: () => string;
export declare const NOW: () => string;
export declare const TODAY: () => string;
export declare const ERROR: () => string;
export declare const LAST_MODIFIED_TIME: () => string;
export declare const RECORD_ID: () => string;
