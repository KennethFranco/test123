...
import { allIndexesValid, isBaseField, isFunc, isJoinArgs, isQueryObject, isQueryObjectArray, isRegexArgs, isRegexReplaceArgs, isString, } from './typeCheckers';
import { regexFunctions, regexReplaceFunction } from './regexFunctions';
import { handleNumericalFunc, numericalFunctions, numericOperators, } from './numericFunctions';
export const operatorFunctions = Object.assign(Object.assign({}, logicalOperators), numericOperators);
export const handleError = (arg) => new Error(`Invalid Query Object, ${JSON.stringify(arg)}`);
export const queryBuilder = (arg) => {
    if (arg !== undefined) {
