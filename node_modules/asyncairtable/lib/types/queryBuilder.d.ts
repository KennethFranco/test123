import { AirtableUpdateRecord, SelectOptions, TextSearchArgs, RegexArgs } from './';
import { IfArgs, SwitchArgs } from './queryBuilder/logical';
import { CeilFloorArg, LogArg, ModArg, PowerArg, RoundArg } from './queryBuilder/numeric';
...
/** @ignore */
declare type ErrorFunc = () => string;
/** @ignore */
export interface ErrorFuncs extends Record<string, ErrorFunc> {
    $error: ErrorFunc;
}
/** @ignore */
export declare type QueryField = QueryObject | QueryField[] | AirtableFilters | BaseFieldType | (() => string) | undefined;
/** @ignore */
export declare type BaseFieldType = string | number | boolean | null;
/**@ignore */
export declare type UncheckedArray = (QueryField | QueryField[] | undefined)[];
/** @ignore */
...
export declare type FieldNameObject = {
    $fieldName: string;
};
...
export declare type TextArg = string | FieldNameObject | QueryObject;
export declare type NumArg = number | FieldNameObject | QueryObject;
export declare type BoolArg = boolean | FieldNameObject | QueryObject;
export {};
