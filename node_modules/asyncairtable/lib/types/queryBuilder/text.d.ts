...
/** @ignore */
declare type TextSearchFunction = (arg: TextSearchArgs) => string;
declare type TextReplaceFunction = (arg: TextReplaceArgs) => string;
declare type TextSubFunction = (arg: TextSubArgs) => string;
declare type TextConcatFunction = (args: TextArg[]) => string;
declare type TextDoubleArgFunc = (arg: TextDoubleArg) => string;
declare type TextSingleArgFunc = (arg: TextArg) => string;
declare type TextMidFunc = (arg: TextMidArgs) => string;
export interface TextSearchFunctions extends Record<string, TextSearchFunction> {
    $find: TextSearchFunction;
    $search: TextSearchFunction;
}
export interface TextReplaceFunctions extends Record<string, TextReplaceFunction> {
...
export interface TextConcatFunctions extends Record<string, TextConcatFunction> {
    $concatenate: TextConcatFunction;
}
export interface TextDoubleArgumentFunctions extends Record<string, TextDoubleArgFunc> {
...
export interface TextSingleArgumentFunctions extends Record<string, TextSingleArgFunc> {
