...
declare type SingleArgFunc = (arg: QueryField) => string;
declare type AddFunc = (arg: AddArg) => string;
declare type DiffFunc = (arg: DiffArg) => string;
declare type SameFunc = (arg: SameArg) => string;
declare type FormatFunc = (arg: FormatArg) => string;
declare type ParseFunc = (arg: ParseArg) => string;
declare type PastFutureFunc = (arg: DoubleDateObj) => string;
declare type WeekFunc = (arg: WeekArg) => string;
declare type WorkDayFunc = (arg: WorkDayArg) => string;
declare type WorkDayDiffFunc = (arg: WorkDayDiffArg) => string;
declare type LastModifiedFunc = (arg: string[]) => string;
